...
export type NodeType =
  ...
  | 'control' | 'communication' | 'strike' | 'assessment'

export type EdgeType = 'communication' | 'command' | 'support' | 'feedback'
...
export const NODE_TYPES: { value: NodeType; label: string; color: string; shape: string; icon: string }[] = [
  ...
  { value: 'control', label: '控制节点', color: '#eb2f96', shape: 'round-diamond', icon: 'control' },
  { value: 'communication', label: '通信节点', color: '#13c2c2', shape: 'parallelogram', icon: 'wifi' },
